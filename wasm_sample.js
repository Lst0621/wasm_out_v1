...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_wasm_add')) {
        Object.defineProperty(Module['ready'], '_wasm_add', { configurable: true, get: function() { abort('You are getting _wasm_add on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_wasm_add', { configurable: true, set: function() { abort('You are setting _wasm_add on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_wasm_minus')) {
        Object.defineProperty(Module['ready'], '_wasm_minus', { configurable: true, get: function() { abort('You are getting _wasm_minus on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_wasm_minus', { configurable: true, set: function() { abort('You are setting _wasm_minus on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _wasm_add = Module["_wasm_add"] = createExportWrapper("wasm_add");

/** @type {function(...*):?} */
var _wasm_minus = Module["_wasm_minus"] = createExportWrapper("wasm_minus");
